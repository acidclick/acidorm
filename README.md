...
v2.0 replaces PHPDoc annotations with PHP 8 native attributes. A migration script is included to convert existing entity files automatically.
...
| Branch | PHP  | Annotations |
|--------|------|-------------|
| v1.0   | 7.4+ | PHPDoc (`/** @label ... */`) |
| v2.0   | 8.0+ | PHP attributes (`#[Label(...)]`) |
| v3.0   | 8.4+ | PHP attributes + `readonly class` |
